...
```{r}
MQ_df<-read.csv("Distances_Quaternary_Oxford_Oxford_Callovian.txt", header = TRUE, sep = ";", dec=".")
```
...
```{r}
MQ_dft<-read.csv("Distances_Quaternary_Oxford_Czestochowa_Koscieliska.txt", header = TRUE, sep = ";", dec=".")
```
...
```{r}
MQ_dft<-read.csv("Distances_Oxford_Callovian_Czestochowa_Koscieliska.txt", header = TRUE, sep = ";", dec=".")
```
...
```{r}
difmap1a<-read.csv("Distances_Quaternary_Oxford_Oxford_Callovian.txt", header = TRUE, sep = ";", dec=".")
difmap1b<-read.csv("Distances_Quaternary_Oxford_Czestochowa_Koscieliska.txt", header = TRUE, sep = ";", dec=".")
```
...
```{r}
difmap1a<-read.csv("Distances_Quaternary_Oxford_Oxford_Callovian.txt", header = TRUE, sep = ";", dec=".")
difmap1b<-read.csv("Distances_Oxford_Callovian_Czestochowa_Koscieliska.txt", header = TRUE, sep = ";", dec=".")
```
...
```{r}
difmap1a<-read.csv("Distances_Quaternary_Oxford_Czestochowa_Koscieliska.txt", header = TRUE, sep = ";", dec=".")
difmap1b<-read.csv("Distances_Oxford_Callovian_Czestochowa_Koscieliska.txt", header = TRUE, sep = ";", dec=".")
```
