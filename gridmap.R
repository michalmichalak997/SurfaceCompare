...
tab0<-read.csv("quaternary_oxford_aalen_good_columns_output_0.txt", sep=";", dec=".")
tab1<-read.csv("quaternary_oxford_aalen_good_columns_output_1.txt", sep=";", dec=".")
tab2<-read.csv("quaternary_oxford_aalen_good_columns_output_2.txt", sep=";", dec=".")
...
gridpliknazwa<-"quaternary_oxford_aalen_good_columns_grid_locate"
...
colnames(nmerged)
ekspert_pal<- c("green", "black", "blue", "red")
